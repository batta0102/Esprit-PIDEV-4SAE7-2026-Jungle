...
public class VenueController {
    ...
    public void delete(@PathVariable Long id) {
        ...
        var onsiteEventIds = onsiteEventRepository.findIdsByVenueId(id);
        if (onsiteEventIds != null && !onsiteEventIds.isEmpty()) {
            eventRegistrationRepository.deleteByEventIdIn(onsiteEventIds);
        }
