...
import { AdminClubForumComponent } from './pages/admin-club-forum/admin-club-forum.component';
...
export const BACK_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/admin-club-forum/admin-club-forum.component').then(m => m.AdminClubForumComponent)
  },
  {
    path: 'dashboard',
