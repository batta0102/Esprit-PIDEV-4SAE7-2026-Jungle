...
export const routes: Routes = [
  ...
  // === SCANNER AND VOCABULAIRE ROUTES ===
  {
    path: 'scanner',
  ...
  // === DEBUG ROUTES ===
  {
    path: 'debug/disponibilites',
    loadComponent: () => import('./pages/disponibilite-test/disponibilite-test.component').then(m => m.DisponibiliteTestComponent),
    title: 'Debug Disponibilités'
  },
  {
    path: 'debug/notification',
    loadComponent: () => import('./pages/test-notification/test-notification.page').then(m => m.TestNotificationPage),
    title: 'Test Notifications'
  },
  {
    path: 'debug/clubs',
    loadComponent: () => import('./components/club-management/club-management.component').then(m => m.ClubManagementComponent),
    title: 'Debug Clubs API Gateway'
  },
  {
