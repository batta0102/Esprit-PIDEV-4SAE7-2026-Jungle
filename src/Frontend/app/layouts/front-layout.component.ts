        ...
        <div class="container footer-top">
          ...
          <div class="footer-right">
            ...
            <nav class="footer-links" aria-label="Useful links">
              <a class="footer-nav-link" routerLink="/front/courses">Courses</a>
              <a class="footer-nav-link" routerLink="/front/classrooms">Classrooms</a>
              <a class="footer-nav-link" routerLink="/front/bookings">My Bookings</a>
