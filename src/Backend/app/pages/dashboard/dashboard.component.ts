...
import { BuddySystemCardComponent } from '../../components/buddy-system-card/buddy-system-card.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AppCardComponent, ModuleCardComponent, CalendarComponent, ActivityTimelineComponent, BuddySystemCardComponent],
