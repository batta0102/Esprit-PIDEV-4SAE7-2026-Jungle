...
export class NavigationComponent {
  ...
  navigateTo(page: string): void {
    // Rediriger toujours vers /back/clubs pour 'clubs' au lieu de /clubs
    const targetRoute = page === 'clubs' ? '/back/clubs' : `/back/${page}`;
    console.log(`🔄 Navigation: clic sur '${page}' → redirection vers '${targetRoute}'`);
